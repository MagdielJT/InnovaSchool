...
<pdf>
                ...
                <table class="header" height="90px" style="width: 100%;">
                    <tr height="90px">
                            ...
                            <#if certData?has_content>
                                <#if record.custbody_efx_fe_info_location_pdf == true>
                                    <#if record.custbody_efx_fe_logoloc?has_content>
                                        ...
                                        <img style="float: left; margin: 7px;" width="140" height="70" src="${urldir}"/>
                                    </#if>
                                <#else>
                                ...
                                <#else>
                                    ...
                                    <#else>
                                        <#if infoEmpresa.logo@url?length != 0>
                                            <span><img style="float: left; margin: 7px;" width="140" height="70"
                                                       src="${infoEmpresa.logo@url}"/></span>
                                        <#elseif companyInformation.logoUrl?length != 0>
                                            <img style="float: left; margin: 7px;" width="140" height="70"
                        ...
                        <td colspan="4" style="font-size: 10px;" align="right"><span style="font-size: 12px;"><strong>FACTURA</strong></span><br/>
                            ...
                            <br/> <br/>Fecha<br/>${record.trandate?string('dd/MM/yyyy')}<br/>
                        </td>
                        <td align="right">
    ...
    <#if desglose_json_body?has_content>
        ...
        <#assign totalivaGBL = desglose_body.iva_total>
            ...
            <table style="width: 100%; margin-top: 10px;">
                ...
                <tr>
                    <td colspan="14" rowspan="2"
                        style="border: 1px; border-color: #e3e3e3; font-size:9px;">
        ...
        <#else>
            <table style="width: 100%; margin-top: 10px;">
                ...
                <tr>
                    <td colspan="14" rowspan="2"
                        style="border: 1px; border-color: #e3e3e3; font-size:9px;">
                        ${record.billaddress?upper_case}<br/>RFC: ${dataXML.Receptor.atributos.Rfc}<br/></td>
                    <td></td>
    ...
    <#else>
        ...
        <#else>
            <table style="width: 100%; margin-top: 10px;">
                ...
                <tr>
                    <td colspan="14" rowspan="2"
                        style="border: 1px; border-color: #e3e3e3; font-size:9px;">${record.billaddress?upper_case}<br/>RFC: ${record.custbody_tk_rfc_lm?upper_case}
                        <br/></td>
                    <td></td>
...
<td colspan= "18" style="width: 100%; font-size:10px;">${record.memo}</td>
    ...
    <#list record.item as item>
        <#assign "tipo_articulo" = item.itemtype?keep_before(" ")>
        ...
        <table class="itemtable" style="width: 100%; margin-top: 3px; border: 1px; border-color: #e3e3e3;">
            <#if dataXML.Conceptos.Concepto?is_sequence>
                ...
                <#list dataXML.Conceptos.Concepto as Conceptos>
                                            ...
                                            <#if Conceptos.Impuestos.Traslados.Traslado?has_content>
                                                    ...
                                                    <#list Conceptos.Impuestos.Traslados.Traslado as traslado_imp>
                                                        <tr>
                                                            ...
                                                            <#if traslado_imp.atributos.TipoFactor == "Exento">
                                                                <td align="left" colspan="4"
                                                                    style="font-size: 5pt;padding-top: 0px; padding-bottom: 0px;">0.00%
                                                                </td>
                                                                <td align="left" colspan="4"
                                                ...
                                                <#else>
                                                    <tr>
                                                        ...
                                                        <#if Conceptos.Impuestos.Traslados.Traslado.atributos.TipoFactor == "Exento">
                                                            <td align="left" colspan="4"
                                                                        style="font-size: 5pt;padding-top: 0px; padding-bottom: 0px;">0.00%
                                                                    </td>
                                                                    <td align="left" colspan="4"
                    ...
                    <#if record.custbody_efx_fe_complemento_educativo?has_content && record.custbody_efx_fe_complemento_educativo == true >
                        <tr>
                            <th align="center" colspan="48"
                                style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Complemento educativo
                            </th>

                        </tr>
                        <tr style="margin-top: 3px; border: 1px; border-color: #e3e3e3;">
                            <td colspan="48" style="font-size: 5pt;">
                                <#if Conceptos.ComplementoConcepto.instEducativas.atributos.nombreAlumno?has_content>Nombre del Alumno: ${Conceptos.ComplementoConcepto.instEducativas.atributos.nombreAlumno}
                                    <br/></#if>
                                <#if Conceptos.ComplementoConcepto.instEducativas.atributos.nombreAlumno?has_content>Nivel Educativo: ${Conceptos.ComplementoConcepto.instEducativas.atributos.nivelEducativo}
                                    <br/></#if>
                                <#if Conceptos.ComplementoConcepto.instEducativas.atributos.CURP?has_content>CURP: ${Conceptos.ComplementoConcepto.instEducativas.atributos.CURP}
                                    <br/></#if>
                                <#if Conceptos.ComplementoConcepto.instEducativas.atributos.autRVOE?has_content>AUTRVOE: ${Conceptos.ComplementoConcepto.instEducativas.atributos.autRVOE}
                                    <br/></#if>
                            </td>
                        </tr>
                    </#if>
                ...
                <#list record.item as item>
                    ...
                    <#if tipo_articulo == "Discount">
                        <tr>
                            <td align="center" colspan="2" line-height="150%" style="border-left: 0px; border-top: 1px;border-color: #e3e3e3;font-size: 5pt; padding-top: 1px;">${line_number}</td>
                            <td align="center" colspan="5" line-height="150%" style="border-left: 1px; border-top: 1px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px;">
                                ${item.item}
                            </td>
                            <td colspan="29" line-height="150%" style="border-left: 1px; border-top: 1px;border-color: #e3e3e3; font-size: 5pt; padding-top: 1px;">
                                    ${item.description} <br />
                            </td>
                            <td align="center" colspan="4" line-height="150%" style="border-left: 1px; border-top: 1px;border-color: #e3e3e3; font-size: 5pt; padding-top: 1px;">
                                    %${item.rate *100} <br />
                            </td>
                            <td align="center" colspan="4" line-height="150%" style="border-left: 1px; border-top: 1px;border-color: #e3e3e3; font-size: 5pt; padding-top: 1px;">
                                    ${item.amount} <br />
                            ...
                            <td align="center" colspan="4" line-height="150%" style="border-left: 1px; border-top: 1px;border-color: #e3e3e3;font-size: 5pt; padding-top: 1px;">
                                    ${item.grossamt} <br /><!--importe_discount[item_index]-->
                            </td>
                        </tr>
                    </#if>
                </#list>
            <#else>
                ...
                <#if record.custbody_efx_fe_complemento_educativo?has_content && record.custbody_efx_fe_complemento_educativo == true >
                    ...
                    <tr style="margin-top: 3px; border: 1px; border-color: #e3e3e3;">
                        <td colspan="48" style="font-size: 5pt;">
                            <#if dataXML.Conceptos.Concepto.ComplementoConcepto.instEducativas.atributos.nombreAlumno?has_content>Nombre del Alumno: ${dataXML.Conceptos.Concepto.ComplementoConcepto.instEducativas.atributos.nombreAlumno}
                                <br/></#if>
                            <#if dataXML.Conceptos.Concepto.ComplementoConcepto.instEducativas.atributos.nivelEducativo?has_content>Nivel Educativo: ${dataXML.Conceptos.Concepto.ComplementoConcepto.instEducativas.atributos.nivelEducativo}
                                <br/></#if>
                            <#if dataXML.Conceptos.Concepto.ComplementoConcepto.instEducativas.atributos.CURP?has_content>CURP: ${dataXML.Conceptos.Concepto.ComplementoConcepto.instEducativas.atributos.CURP}
                                <br/></#if>
                            <#if dataXML.Conceptos.Concepto.ComplementoConcepto.instEducativas.atributos.autRVOE?has_content>AUTRVOE: ${dataXML.Conceptos.Concepto.ComplementoConcepto.instEducativas.atributos.autRVOE}
                                <br/></#if>
                        </td>
                    </tr>
                </#if>
                ...
                <#if item.quantity?has_content>
                    <tr>
                        ...
                        <#if desglose_json?has_content>
                                        ...
                                        <td colspan="18" style="border-left: 1px; border-color: #e3e3e3;">
                                            ...
                                            <table style="width: 100%; margin-top: 0px; margin-bottom: 0px;">
                                                ...
                                                <#if desglose.ieps.name?has_content>
                                                    <tr>
                                                        <td align="left" colspan="4"
                                                            style="font-size: 5pt; padding-top: 0px; padding-bottom: 0px;">${nsformat_rate(desglose.ieps.base_importe)?keep_after("$")}</td>
                                                        <td align="left" colspan="4"
                                                        ...
                                                        <td align="left" colspan="4"
                                                            style="font-size: 5pt; padding-top: 0px; padding-bottom: 0px;">${nsformat_rate(desglose.ieps.importe)?keep_after("$")}</td>
                                                    </tr>
                                                </#if>
                                                ...
                                                <#if desglose.iva.name?has_content>
                                                    <tr>
                                                        ...
                                                        <td align="left" colspan="4"
                                                            style="font-size: 5pt; padding-top: 0px; padding-bottom: 0px;">${nsformat_rate(desglose.iva.base_importe)?keep_after("$")}</td>
                                                        <td align="left" colspan="4"
                            ...
                            <td align="center" colspan="4" line-height="150%"
                                style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">${nsformat_rate(item.quantity)?keep_after("$")}</td>
                            <td align="center" colspan="4"
                                style="border-left: 1px; border-color: #e3e3e3; font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">${nsformat_rate(item.rate)?keep_after("$")}</td>
                            <td align="center" colspan="4"
                                style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">${nsformat_rate(item.tax1amt)?keep_after("$")}</td>
                            <#assign "descuento_total" = descuento_total + importe_discount[item_index+1]>
                            <td align="center" colspan="4"
                                style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px; padding-left: 0px; padding-right: 0px;">${nsformat_rate(item.grossamt)?keep_after("$")}</td>
                        </#if>
                    </tr>
                    <#if record.custbody_efx_fe_complemento_educativo?has_content && record.custbody_efx_fe_complemento_educativo == true >
                        <tr>
                            <th align="center" colspan="52"
                                style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Complemento educativo
                            </th>

                        </tr>
                        <tr style="margin-top: 3px; border: 1px; border-color: #e3e3e3;">
                            <td colspan="52" style="font-size: 5pt;">
                                <#if item.custcol_efx_fe_com_edu_nom_alumn?has_content>Nombre del Alumno: ${item.custcol_efx_fe_com_edu_nom_alumn}
                                    <br/></#if>
                                <#if item.custcol_efx_fe_com_edu_nivel_edu?has_content>Nivel Educativo: ${item.custcol_efx_fe_com_edu_nivel_edu}
                                    <br/></#if>
                                <#if item.custcol_efx_fe_com_edu_curp?has_content>CURP: ${item.custcol_efx_fe_com_edu_curp}
                                    <br/></#if>
                                <#if item.custcol_efx_fe_com_edu_clave_autrvoe?has_content>AUTRVOE: ${item.custcol_efx_fe_com_edu_clave_autrvoe}
                                    <br/></#if>
                            </td>
                        </tr>
                    </#if>
    ...
    <#if record.custbody_efx_fe_detalle_imp_loc?has_content>
        ...
        <table class="itemtable" style="width: 100%; margin-top: 3px; border: 1px; border-color: #e3e3e3;">
            <thead>
            <tr style="margin-top: 0px; padding-top: 0px; padding-bottom: 0px">
                <th align="center" colspan="2" style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Impuesto
                    Local
                </th>
                ...
                <th align="center" colspan="2" style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Importe
                </th>
            </tr>
            </thead>
            <#list listaLocales as listadoLocales>
                <tr>
                    <td align="center" colspan="2" line-height="150%"
                        style="border-left: 0px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px;">${listadoLocales.impLocRetenido}</td>
                    <td align="center" colspan="2" line-height="150%"
                        style="border-left: 0px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px;">${listadoLocales.tasadeRetencion}</td>
                    <td align="center" colspan="2" line-height="150%"
                        style="border-left: 0px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px;">${listadoLocales.porcentaje}</td>
                    <td align="center" colspan="2" line-height="150%"
                        style="border-left: 0px; border-color: #e3e3e3;font-size: 5pt; padding-top: 1px;">${listadoLocales.importe}</td>
                </tr>
            </#list>
        </table>
    </#if>
            ...
            <td colspan="2" style="margin: 0px; padding: 0;">
                <table style="width: 100%; margin-top: 0px; margin-left: 0px; border: 0px; border-color: #e3e3e3;">
                        ...
                        <#else>
                            <#if record.custbody_efx_fe_gbl_subtotal?has_content>
                                <td align="right" colspan="1"
                                    style="font-size: 7pt;">${nsformat_rate(record.custbody_efx_fe_gbl_subtotal)?keep_after("$")}</td>
                            <#else>
                                <#if cabecera_subtotal?has_content>
                                    <td align="right" colspan="1"
                                    style="font-size: 7pt;">${nsformat_rate(cabecera_subtotal)?keep_after("$")}</td>
                                    <#else>
                                    <td align="right" colspan="1"
                                    style="font-size: 7pt;">${nsformat_rate(record.subtotal)?keep_after("$")}</td>
                    ...
                    <tr>
                        ...
                        <#else>
                            <#if descuento_total != 0>
                                <td align="right" colspan="1"
                                    style="font-size: 7pt;"><#if desglose_total_discount?has_content>${nsformat_rate(desglose_total_discount)?keep_after("$")}</#if></td>
                            <#else>
                                <#if record.discounttotal != 0>
                                    <td align="right" colspan="1" style="font-size: 7pt;">${nsformat_rate(record.discounttotal)?keep_after("$")}</td>
                                <#else>
                    ...
                    <tr>
                        ...
                        <#else>
                            <td align="right" colspan="1" style="font-size: 7pt;">${nsformat_rate(totalivaGBL)?keep_after("$")}</td>
                        </#if>
                    </tr>
                    <#if dataXML?has_content>
                    ...
                    <#else>
                        <#list obj_totales_imp as Iva_rate, Iva_total>
                            ...
                            <#if Iva_rate == "16" || Iva_rate == "0">
                                <tr>
                                    <td colspan="2" style="font-size: 5pt;">
                                        ${Iva_rate}%: ${nsformat_rate(Iva_total)?keep_after("$")}<br/>
                                    </td>
                                </tr>
                            </#if>
                        </#list>
                    ...
                    <tr>
                        ...
                        <#else>
                            <td align="right" colspan="1"
                                style="font-size: 7pt;"><#if cabecera_total?has_content>${nsformat_rate(cabecera_total)?keep_after("$")}</#if></td>
                        </#if>
